...
const Page = () => {
    ...
    return (
        <div>
            <h1 className={`text-3xl ${lato.className} font-bold uppercase mt-7`}>Cupones</h1>
            {loading ? (
                ...
                <div>
                    {user.userData && user.userData.coupons && user.userData.coupons.length > 0 ? (
                        ...
                        <div className="flex justify-center items-center text-3xl font-bold min-h-screen">No hay cupones disponibles</div>
                    )}
                </div>
            )}
        </div>
