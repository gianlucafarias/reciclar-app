...
const Page = () => {
    ...
    const logout = async () => {
        try {
            ...
            Toast.SuccessshowToast("Has Cerrado tu sesión con exito.");
            router.refresh();
            router.push("/");
        } catch (error: unknown) {
        ...
        <>
            {loading ? (
                ...
                <div className={`${lato.className} flex flex-col  min-h-[90vh]`}>
                    <h1 className=" text-4xl font-bold tracking-wide mt-3">Perfil</h1>
                    <div className=" bg-green-600 rounded-3xl w-full h-48 mt-12">
                        <div className="flex relative flex-col text-white justify-center items-center h-full">
                            <div className="flex flex-col gap-2 relative">
                                ...
                                <h1 className=" text-3xl font-bold tracking-wide capitalize">{user?.userData?.referralCode}</h1>
                            ...
                            <div className="absolute bg-white border-2 border-black/10 text-black shadow-lg shadow-black/10 rounded-lg h-36 top-40 w-[80%] m-auto ">
                                <div className="flex justify-between items-center h-full">
                                    <div className="flex flex-col justify-center p-2 items-center">
                                        ...
                                        <span className="  uppercase text-xs opacity-70 font-semibold tracking-wider">Puntos</span>
                                    </div>
                                    ...
                                    <div className="flex flex-col justify-center items-center p-2">
                                        ...
                                        <span className="  uppercase text-xs opacity-70 font-semibold tracking-wider">Reciclado</span>
                                    </div>
                                </div>
                            </div>
                        </div>
